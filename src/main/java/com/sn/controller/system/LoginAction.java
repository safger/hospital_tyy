...
public class LoginAction {
	...
	public String show(String sysname){
	...
	public String login(String username,String password){
		if(username!=null&&password!=null){
			...
			if(baseUser_list!=null&&baseUser_list.size()>0){
				...
				request.getSession().setAttribute("realname",baseUser_list.get(0).getRealname());
				request.getSession().setAttribute("userid",userid);
				request.getSession().setAttribute("departmentid",departmentid);
				request.getSession().setAttribute("userType",baseUser_list.get(0).getUserType());
	...
	/*			//更新最后登录时间
				...
				//----------------
*/				 
				String sysname=(String)request.getSession().getAttribute("sysname");
