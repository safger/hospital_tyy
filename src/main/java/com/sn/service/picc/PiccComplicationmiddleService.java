...
public interface  PiccComplicationmiddleService{ 
	...
	public PagedResult<PiccComplicationmiddle> findByPage(PiccComplicationmiddle record,Integer indexPage,Integer pageSize,String orderBy );
	
	public PagedResult<PiccComplicationmiddle> findByPageCustom(PiccComplicationmiddle record, Integer indexPage,Integer pageSize,String orderBy);
