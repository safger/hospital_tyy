...
<body class="skin-blue layout-top-nav">
						...
						<div class="box-body">
							<div class="head-find">
								...
								<div class="row">
									<div class="col-xs-3">
										<div class="form-new-input">
											<span>会诊护士：</span> <input type="text" id="maintainPeople" class="fis">
										</div>
									</div> 
									<div class="col-xs-3">  
										<div class="form-new-input">
											<span>会诊级别：</span> <select  id="consultationLevel"
												class="fis">
					...
					<div class="col-xs-12">
						<div class="box">
							<div class="box-header">
								<h3 class="box-title">PICC穿刺会诊查询</h3>
							</div>
							<!-- /.box-header -->
	...
	<form id="mform" action="<%=basePath%>backstage/piccPunctureconsultation/showEdit.html" method="post">
      	<input type="hidden" id="patientId" name="patientId" value="" /> 
      	<input type="hidden" id="cpunctureId" name="cpunctureId" value="" /> 
      </form>
	<!-- Modal detail -->
...
$(function() {
    ...
    var template = Handlebars.compile(tpl);
	 ...
	 table = $('#newAttributeTable').dataTable( { 
        ...
        "ajax": "<%=basePath%>backstage/piccPunctureconsultation/getDate.html",
        "columns": [{ "data": null, 
       	  			...
       	  			"createdCell" : function(nTd, sData, oData,
						  ...
						  { "data": "createdate", 
							 ...
							 { "data": "purpose", 
								 "title" : "会诊目的" },
								 { "data": "consultationLevel", 
									 "title" : "会诊级别" },
									 { "data": "sapplicant",  
										 "title" : "申请护士" },
										 { "data": "consultationPeople", 
											 "title" : "会诊护士" },
					  { "data" : null,
						"title" : "操作"
						}], 
		"columnDefs": [   
					{ "bSortable": false, "aTargets": [ 0,11  ] },   //不排序的列
					  {  
						  targets: 1,
					  ...
					  {  
						  ...
						  render: function(data,type,row,meta){ 
							  var ht="";
							  if(data==1){
								  ht='<small class="label label-success">一般</small>';
							  }
							  if(data==2){
								  ht='<small class="label label-danger">急</small>';
							  }
							  return ht;
						  }
					  }, 
    ...
    function del(fuid) {
        ...
        $.ajax({
            url: "<%=basePath%>backstage/piccPunctureconsultation/delete.html",
            data: {
                "fuid": fuid
    ...
    function gsearch() {
		var consultationLevel = $("#consultationLevel option:selected").val();
		var ward = $("#ward").val();
		...
		var data = consultationLevel + "," + ward + "," + clinicnumber + ","
				+ patient + "," + stime + "," + etime + ","
				+ maintainPeople+","+hospitalnumber;
		table.fnFilter(data);
	}
